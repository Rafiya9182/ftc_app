...
/**
 * Created by samhalterman on 9/19/17.
 */
...
public class samLearningCode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Go = hardwareMap.dcMotor.get("Glo");
        ...
        Go.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        // Send telemetry message to indicate successful Encoder reset
        telemetry.addData("Path0",  "Starting at %7d",
                Go.getCurrentPosition());
        telemetry.update();
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newTarget = Go.getCurrentPosition() + (int)(Inches * COUNTS_PER_INCH);
            Go.setTargetPosition(newTarget);
            // Turn On RUN_TO_POSITION
            Go.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            // reset the timeout time and start motion.
            runtime.reset();
            Go.setPower(Math.abs(speed));
